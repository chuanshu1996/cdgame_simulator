    ...
    <div class="rules-container">
        ...
        <div class="rules-content">
            <a-anchor :affix="true" :offsetTop="80" class="rules-nav">
                ...
                <a-anchor-link href="#energy-system" title="能量系统" />
            ...
            <div class="rules-main">
                ...
                <section id="energy-system" class="rule-section">
                    <h2><a-icon type="fire" /> 能量系统</h2>
                    
                    <a-row :gutter="16">
                        <a-col :span="12">
                            <a-card title="能量机制" size="small">
                                <ul class="rule-list">
                                    <li>每个队伍独立拥有能量资源</li>
                                    <li>初始能量：<strong>4点</strong></li>
                                    <li>最大能量：<strong>8点</strong></li>
                                </ul>
                            </a-card>
                        </a-col>
                        <a-col :span="12">
                            <a-card title="能量条" size="small">
