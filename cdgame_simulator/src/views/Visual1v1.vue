<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <div class="debug">
        ...
        <div class="team-field" v-for="teamId in 2" :key="teamId">
            <div class="energy">{{energyNum2Text(data.energy[teamId -1])}} {{data.energy[teamId -1].progress}} <span class="infinite-energy">(无限)</span></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.battle.infiniteEnergy = true;
        ...
        methods: {
            ...
            refillEnergy() {
                if (this.battle.energys && this.battle.energys.length >= 2) {
                    this.battle.energys[0].num = 8;
                    this.battle.energys[1].num = 8;
                }
            },
