                    ...
                    <table class="stats-table">
                        <thead>
                            <tr>
                                ...
                                <th class="col-data">能量消耗<br><span class="percent-hint">%</span></th>
                        ...
                        <tbody>
                            <tr v-for="(unit, index) in teamData.units" :key="'unit-' + teamIndex + '-' + index"
                                ...
                                <td class="col-data">
                                    <div class="data-value">{{ unit.energyUsed.toFixed(2) }}</div>
                                    <div class="data-percent">{{ unit.energyPercent }}%</div>
                                    <div class="progress-bar">
                                        <div class="progress-fill energy-fill" :style="{width: unit.energyPercent + '%'}"></div>
                                    </div>
                                </td>
                                <td class="col-data">
    ...
    export default {
        ...
        methods: {
            calculateStats() {
                ...
                const teams = [{ units: [], totals: { damage: 0, damageTaken: 0, maxHit: 0, energy: 0, heal: 0, shield: 0, control: 0 } }, 
                ...
                this.battle.entities.forEach((entity, entityId) => {
                    ...
                    const stats = {
                        ...
                        energyUsed: Number(entity.battleData?.get('energyUsed')) || 0,
                ...
                teams.forEach((team, teamIndex) => {
                    team.units.forEach(unit => {
                        ...
                        unit.energyPercent = team.totals.energy > 0 ? (unit.energyUsed / team.totals.energy * 100).toFixed(1) : '0.0';
            ...
            saveMatchRecord() {
                ...
                try {
                    ...
                    if (this.battle) {
                        ...
                        winnerName = winner === 0 ? this.team0Name : winner === 1 ? this.team1Name : '平局';
                        loserName = winner === 0 ? this.team1Name : winner === 1 ? this.team0Name : '平局';
