...
import {kambara_tomomi_skill1, kambara_tomomi_skill2, kambara_tomomi_skill3, kambara_tomomi_skill4} from './c/kambara-tomomi';
import {abuku_riko_skill1, abuku_riko_skill2, abuku_riko_skill3} from './c/abuku-riko';
import {shinshi_nozomu_skill1, shinshi_nozomu_skill2, shinshi_nozomu_skill3} from './c/shinshi-nozomu';
import {shogaku_nijoizumi_skill1, shogaku_nijoizumi_skill2, shogaku_nijoizumi_skill3} from './c/shogaku-nijoizumi';
import {tanaka_mai_skill1, tanaka_mai_skill2, tanaka_mai_skill3} from './c/tanaka-mai';
...
export const HeroTable = new Map<number, any>(map(HeroData, (data) => [Number(data.index), data]));
...
function HERO(name: string, skills: Skill[], ai: AI = normalAI) {
    ...
    if (dd.show === 1) {
        build(Number(dd.index), [], ai, ...skills);
    }
}
...
HERO('蒲原智美', [
    kambara_tomomi_skill1,
    kambara_tomomi_skill2,
    kambara_tomomi_skill3,
    kambara_tomomi_skill4,
]);
...
HERO('新子望', [
    shinshi_nozomu_skill1,
    shinshi_nozomu_skill2,
    shinshi_nozomu_skill3,
]);

HERO('小学二条泉', [
    shogaku_nijoizumi_skill1,
    shogaku_nijoizumi_skill2,
    shogaku_nijoizumi_skill3,
]);
...
HERO('古冢梢', [
    furutsuka_kozue_skill1,
    furutsuka_kozue_skill2,
    furutsuka_kozue_skill3,
    furutsuka_kozue_skill4,
]);
