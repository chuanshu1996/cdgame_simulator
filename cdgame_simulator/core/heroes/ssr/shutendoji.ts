...
export const shutendoji_skill3: Skill = {
    ...
    name: '狂啸', // 技能名称
    cost: 3, // 技能消耗
    text: '消耗所有【狂气】，恢复30%生命值，增加50%行动条，获得【鬼王降临】形态。形态期间免疫控制，附带10%吸血效果。持续时间等于消耗的【狂气】层数。消耗3点能量。',
    handlers: [
        {
            /**
             * 处理buff移除事件
 ...
 * @returns 技能选择对象
 */
export function shutendojiAI(battle: Battle, turnData: TurnProcessing, energy: Energy | null, selections: SelectableSkill[]): SkillSelection | null {
