...
export const utsuki_tamako_skill1: Skill = {
    ...
    text: '别想一发，对单体目标造成攻击力50%的伤害，并降低目标10%行动条进度。',
...
export const utsuki_tamako_skill2: Skill = {
    ...
    passive: true,
    cost: 0,
    text: '被动技能。当自身单次造成超过4000点的伤害时，为全队施加1层【信心】buff；当自身死亡时，全队【信心】buff转变为【灰心】debuff。【信心】：攻击力提升20%，最多叠加5层，持续至战斗结束。【灰心】：效果抵抗降低20%，最多叠加5层，持续至战斗结束。',
    handlers: [
        // 造成伤害后检查是否超过4000点
        {
...
export const utsuki_tamako_skill3: Skill = {
    ...
    cost: 2,
    target: SkillTarget.ENEMY,
    text: '牺牲自身10%最大生命值，对单体目标造成攻击力300%的伤害。',
    use(battle: Battle, sourceId: number, selectedId: number) {
        const source = battle.getEntity(sourceId);
        if (!source) return;
