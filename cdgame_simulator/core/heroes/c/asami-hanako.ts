...
export const asami_hanako_skill1: Skill = {
    ...
    text: '对单体目标造成攻击力100%的伤害，并使自身获得1层【加速】buff。【加速】：速度提升5点，最多叠加10层，持续至战斗结束。',
...
export const asami_hanako_skill2: Skill = {
    ...
    text: '被动技能。当自身【加速】buff叠满10层时，自身返回替补位，替补位选手上场并继承自身当时的生命值与行动条进度，同时获得10层【加速】buff。',
    handlers: [
        {
...
export const asami_hanako_skill3: Skill = {
    ...
    cost: 3,
    target: SkillTarget.ENEMY,
    text: '对所有速度低于自身的敌方角色各发动一次【加速】攻击，每次造成攻击力100%的伤害，并追加一次（速度差×20）的伤害；随后自身获得2层【加速】buff（若自身速度为全场最高，则额外再获得1层）。',
    use(battle: Battle, sourceId: number, selectedId: number) {
        const source = battle.getEntity(sourceId);
        if (!source) return;
