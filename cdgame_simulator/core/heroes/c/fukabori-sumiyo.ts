...
export const fukabori_sumiyo_skill1: Skill = {
    ...
    text: '老老实实立直，对单体目标造成攻击力125%的伤害；造成伤害时对目标施加【缓速】debuff，持续至战斗结束。【缓速】：速度降低10点。',
...
export const fukabori_sumiyo_skill2: Skill = {
    ...
    text: '被动技能。当队友受到一次单体攻击时，由自身承担本次伤害的50%。',
    handlers: [
        {
...
export const fukabori_sumiyo_skill3: Skill = {
    ...
    hide: true,
    target: SkillTarget.ENEMY,
    text: '【限定技】当裁判旗行动至第5回合后可使用，整场战斗仅限一次。对敌方全体造成攻击力150%的真实伤害，并按造成的伤害量回复自身生命值。',
...
fukabori_sumiyo_skill1_normal.text = '老老实实立直，对单体目标造成攻击力125%的伤害。';
