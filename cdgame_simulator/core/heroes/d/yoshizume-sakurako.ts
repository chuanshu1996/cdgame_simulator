...
export const yoshizume_sakurako_skill1: Skill = {
    ...
    text: '熊孩子发起头槌，对单体目标造成攻击力125%的伤害，并有5%基础概率（受效果命中加成）对其施加【眩晕】控制效果，持续1回合。',
...
export const yoshizume_sakurako_skill2: Skill = {
    ...
    passive: true,
    cost: 0,
    text: '被动技能。当自身受到伤害时，有15%基础概率（受效果命中加成）对攻击者施加【眩晕】控制效果，持续1回合（多段伤害不会重复触发）。',
    handlers: [
        {
...
export const yoshizume_sakurako_skill3: Skill = {
    ...
    text: '对单体目标连续攻击3次，每次造成攻击力22%的伤害，每段均有8%基础概率（受效果命中加成）对其施加【眩晕】控制效果，持续1回合。优先攻击攻击力最高的目标。',
    use(battle: Battle, sourceId: number, selectedId: number) {
        const source = battle.getEntity(sourceId);
        if (!source) return;
