...
yorukuchi_yayoi_skill1.text = '认真打牌，对单体目标造成攻击力125%的伤害。';
...
export const yorukuchi_yayoi_skill2: Skill = {
    ...
    text: '被动技能。【先机】为全队施加【憧憬凶星】buff，效果命中提升20%，持续2回合。（应援位也可以触发）',
    handlers: [
        {
...
export const yorukuchi_yayoi_skill3: Skill = {
    ...
    text: '对敌方全体造成攻击力50%的伤害；造成伤害时有25%基础概率（受效果命中加成）对目标施加【混乱】控制效果，持续1回合。【混乱】：只能使用普通攻击，且随机选择攻击目标（包括其自身队友）。',
...
export const yorukuchi_yayoi_skill4: Skill = {
    ...
    cost: 0,
    target: SkillTarget.TEAM,
    text: '【部长技】当队伍（包括队伍设置中8个位置）中有3位及以上石莲寺小学的成员时先机发动，所有石莲寺小学的选手获得【石莲寺】buff，攻击力和防御力提升10%。',
    handlers: [
        {
            handle(battle: Battle, data: RealEventData) {
                if (!data.skillOwnerId) return 0;
