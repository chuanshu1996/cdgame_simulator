...
export const ishi_to_meisei_skill1: Skill = {
    ...
    text: '巫女服下也这么有实力，对单体目标造成防御力300%的伤害。',
...
export const ishi_to_meisei_skill2: Skill = {
    ...
    passive: true,
    cost: 0,
    text: '被动技能。【先机】自身获得【没做作业】debuff，持续3回合。【没做作业】：速度降低50点。',
    handlers: [
        {
...
export const ishi_to_meisei_skill3: Skill = {
    ...
    text: '为自身及防御力最高的队友施加【重量级候补】buff，持续2回合。【重量级候补】：防御力提升400点。（应援位也可以触发，整场战斗仅限开场一次）',
    handlers: [
        {
            handle(battle: Battle, data: RealEventData) {
                if (!data.skillOwnerId) return -1;
 ...
 * @returns 技能选择对象
 */
export function ishiToMeiseiAI(battle: Battle, turnData: TurnProcessing, energy: Energy | null, selections: SelectableSkill[]): SkillSelection | null {
