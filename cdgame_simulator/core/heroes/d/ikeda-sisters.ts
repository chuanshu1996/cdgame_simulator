...
export const ikeda_sisters_skill1: Skill = {
    ...
    text: '发动吵闹攻势，对单体目标连续攻击3次，每次造成攻击力33%的伤害（每段伤害独立计算暴击与效果命中）。',
...
export const ikeda_sisters_skill2: Skill = {
    ...
    passive: true,
    cost: 0,
    text: '被动技能。当自身受到致命伤害时，保留1点生命值免于死亡，每场战斗最多触发2次（触发后不会解除自身的控制效果）。',
    handlers: [
        {
...
export const ikeda_sisters_skill3: Skill = {
    ...
    text: '分别为己方攻击力最高、防御力最高、速度最高的单位施加【三重声援·攻击】【三重声援·防御】【三重声援·速度】buff，持续1回合。【三重声援】：对应属性提升30%（按目标基础属性计算）。',
    handlers: [
        {
            handle(battle: Battle, data: RealEventData) {
                if (!data.skillOwnerId) return -1;
