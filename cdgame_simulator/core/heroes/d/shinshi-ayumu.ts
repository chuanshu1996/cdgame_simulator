...
shinshi_ayumu_skill1.text = '稳扎稳打，对单体目标造成攻击力125%的伤害。';
...
export const shinshi_ayumu_skill2: Skill = {
    ...
    text: '被动技能。【先机】战斗开始时获得3层【缜密心理】buff；此后每次受到攻击时额外获得1层，最多叠加10层，持续至战斗结束。【缜密心理】：每层使防御力提升10%、效果抵抗提升10%。',
    handlers: [
        {
...
export const shinshi_ayumu_skill3: Skill = {
    ...
    text: '为全体队友施加1层【陪伴】buff（队友为野上叶子时额外多施加1层）；施放时可消耗【缜密心理】层数抵扣能量，1层抵扣1点，最多抵扣3点。【陪伴】：可抵挡1次控制效果，持续1回合；若持续时间自然结束且未抵挡控制效果，则回复其5%最大生命值。',
