...
export const shogakusei_rei_skill1: Skill = {
    ...
    text: '投掷立直棒，对单体目标造成攻击力150%的伤害，并对其施加【立直威慑】debuff，持续至战斗结束。【立直威慑】：目标受到名称含"立直"的技能攻击后，防御力降低20点，最多叠加10层，持续至战斗结束。',
...
export const shogakusei_rei_skill2: Skill = {
    ...
    passive: true,
    cost: 0,
    text: '被动技能。当自身受到致命伤害时自动触发，免除本次伤害并立即回复自身20%最大生命值，同时获得【预知梦】buff，每场战斗最多触发1次。【预知梦】：造成伤害时，回复相当于该伤害量20%的生命值，持续2回合。',
    handlers: [
        {
...
export const shogakusei_rei_skill3: Skill = {
    ...
    cost: 3,
    target: SkillTarget.ENEMY,
    text: '对敌方全体造成攻击力130%的伤害；若目标拥有【立直威慑】debuff，则额外对其施加【害怕】debuff，持续1回合。【害怕】：每回合有50%概率无法进行攻击与造成伤害。',
    use(battle: Battle, sourceId: number, selectedId: number) {
        const source = battle.getEntity(sourceId);
        if (!source) return;
